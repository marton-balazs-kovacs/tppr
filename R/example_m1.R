...
#' supports the M1 hypothesis.
#' 
#' @format Dataframe with 233422 rows and 23 variables.
#' \describe{
...
#' }
#' @source \url{"https://raw.githubusercontent.com/kekecsz/Transparent_psi_RR_materials/master/TPP_example_data_M1.zip"}
"example_m1"